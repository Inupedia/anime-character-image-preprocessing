...
class ImageCropper:
    def __init__(self, image_directory="./src/output", save_directory="./src/output"):
    ...
    def crop_and_save_all(self):
        for filename in tqdm(self.image_files, desc="Cropping images"):
            ...
            save_path = os.path.join(self.save_directory, f"{base_name}_cropped{ext}")
